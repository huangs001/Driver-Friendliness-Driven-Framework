...
struct CustomizableContractionHierarchyMetric{
	...
	CustomizableContractionHierarchyMetric(const CustomizableContractionHierarchy&cch, const friend_weight*input_weight);
	CustomizableContractionHierarchyMetric(const CustomizableContractionHierarchy&cch, const std::vector<friend_weight>&input_weight);

	CustomizableContractionHierarchyMetric& reset(const CustomizableContractionHierarchy&cch, const friend_weight*input_weight);
	CustomizableContractionHierarchyMetric& reset(const CustomizableContractionHierarchy&cch, const std::vector<friend_weight>&input_weight);

	CustomizableContractionHierarchyMetric& reset(const friend_weight*input_weight);
	CustomizableContractionHierarchyMetric& reset(const std::vector<friend_weight>&input_weight);
...
// private:
	std::vector<friend_weight>forward;
	std::vector<friend_weight>backward;
	const CustomizableContractionHierarchy*cch;
	const friend_weight*input_weight;
...
struct CustomizableContractionHierarchyQuery{
	...
	CustomizableContractionHierarchyQuery& get_distances_to_targets(friend_weight*dist);
	std::vector<friend_weight> get_distances_to_targets();
	...
	CustomizableContractionHierarchyQuery& get_distances_to_sources(friend_weight*dist);
	std::vector<friend_weight> get_distances_to_sources();

// private:
	std::vector<friend_weight>forward_tentative_distance, backward_tentative_distance;
